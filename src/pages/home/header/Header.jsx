...
const Header = ()=>{
    ...
    return (
        ...
        <div className="relative  z-10 w-full">
            ...
            <ContentWrapper>
                ...
                <div className="flex w-full  flex-row items-center justify-between mt-4 font-clash text-[20px]">
                    <div  className=" flex flex-row items-center gap-16 ">
                        ...
                        {menu.map((e,i)=>(<li className="hidden sm:block cursor-pointer">{e}</li>))}

                        </ul>  
                    </div>
                    <button className="hidden sm:block bg-black text-white px-6 py-2 rounded-md">
                        Download
                    </button>
                ...
                <div className=" mt-4 flex flex-col  sm:flex-row ">
                    <div className="left flex-1  flex flex-col gap-2 sm:gap-3 sm:pt-14" >
                        ...
                        <div className="flex font-clash">
                            <span className=" bg-black text-white text-sm sm:text-lg px-6 h-12  rounded-md flex flex-row w-fit items-center gap-2">
            ...
            <img className="absolute w-12 top-16 right-2 sm:top-20 sm:right-8  lg:top-10 lg:right-10 xl:right-40 xl:top-20" src={star1} alt="" />
            <img className="absolute w-12 top-80 left-14 sm:top-96  lg:top-16 lg:left-10 xl:left-28 " src={star3} alt="" />
